...
const NewOrdersScreen=({navigation})=>{
    return(
        ...
        <TouchableOpacity style={{justifyContent:'center',alignItems:'center'}} onPress={()=>{navigation.navigate('OrderDetailScreen')}}>
        ...
        <View>
             ...
             <View style={{marginLeft:20}}> 
                 ...
                 <Text style={{color:'#343434',marginBottom:5}}>Chennai Eco Motors</Text>
                 <Text style={{color:'#343434',marginBottom:5}}>Self</Text>
