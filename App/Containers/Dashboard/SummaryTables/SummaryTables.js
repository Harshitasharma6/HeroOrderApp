...
class SummaryTables extends React.Component {
	filteredData(list) {
  	...
  	getTableHead() {
	    ...
	    return (isASM ? ['PSM', 'Target', 'Achieved', 'Month'] : ['Target', 'Achieved', 'Month'])
  	}
  	...
  	render() {
    	...
    	return (
    		<View style={{paddingHorizontal: 15, paddingVertical: 15}}>
				{/* <Separator /> */}
		    	{/* <SingleInfo heading={'Cretical OutStanding Info'} value={'None'} />
			       <Table tableHead={ordersData.tableHead} tableData={ordersData.tableData} />
			   	<Separator /> */}

			    <SingleInfo heading={'Critical OutStanding Info'} value={'None'} />
			      <Table tableHead={countersData.tableHead} tableData={countersData.tableData} />
			   	<Separator />

			   	<SingleInfo heading={'Communication from Admin'} value={'None'} />
			      {/* <Table tableHead={sitesData.tableHead} tableData={sitesData.tableData} /> */}
				  <TextArea
                    
					placeholder={'Admin Info'}
					numberOfLines={6}
					value={'This message sended by admin. '}
					disable= {true}
					// onChange={(value) => console.log('Remark')}
						// label={'Write text here*'}
					// onChange={(value) => {
					// 	this.props.changeNonShreeForm({ edited_field: 'AddComment', edited_value: value })
					// }}
			   	...
			   	<SingleInfo heading={'Feed Back'} value={'None'} />
