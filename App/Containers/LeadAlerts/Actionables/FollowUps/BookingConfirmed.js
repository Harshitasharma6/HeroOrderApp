...
const mapStateToProps = (state) => ({
    data    : state.leadAlerts.bookingConfirmFinanceLeads,
    loading : state.leadAlerts.loaders.fetchBookingConfirmFinanceLeadsLoader,
    productsList: state.common.productsList,
});

const mapDispatchToProps = (dispatch) => ({
  fetchData: (params)    => dispatch(LeadAlertActions.fetchBookingConfirmFinanceLeads(params)),
