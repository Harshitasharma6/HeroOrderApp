...
class OpenHotAssignedLeads extends Component {
  componentDidMount() {
    this.fetchCall()
  }
...
const mapStateToProps = (state) => ({
    data    : state.leadAlerts.openLeads,
    loading : state.leadAlerts.loaders.fetchOpenLeadsLoader,
    productsList: state.common.productsList,
});

const mapDispatchToProps = (dispatch) => ({
  fetchData: (params)    => dispatch(LeadAlertActions.fetchOpenLeads(params)),
