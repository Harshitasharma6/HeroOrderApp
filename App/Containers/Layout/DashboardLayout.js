    ...
    return (
      <View>
        ...
        <WhiteButton
              ...
              onPress={() => {NavigationService.navigate('CommunicationScreen') ; this.scrollToIndex(0)}}
              selected={this.props.currentScreen == 'CommunicationsAttachmentsScreen' || this.props.currentScreen == 'CommunicationScreen' }
            />
        ...
        <WhiteButton
              ...
              style={Styles.actionButton}
              textStyle={Styles.actionButtonText}
              onPress={() => {NavigationService.navigate('OutStandingScreen'); this.scrollToIndex(2)}}
