            ...
            <View>
                <Header transparent style={Styles.header}>
                        ...
                        <WhiteButton
                          ...
                          onPress={() => {NavigationService.navigate('InfluencerInfoScreen'); this.scrollToIndex(0)}}
                      ...
                      <WhiteButton
                          ...
                          style={Styles.actionButton}
                          textStyle={Styles.actionButtonText}
                          onPress={() => {NavigationService.navigate('NewInfluencerVisitForm'); this.scrollToIndex(1)}}
                        ...
                        <WhiteButton
                          ...
                          style={Styles.actionButton}
                          textStyle={Styles.actionButtonText}
                          onPress={() => {NavigationService.navigate('InfluencerVisitsList'); this.scrollToIndex(2)}}
