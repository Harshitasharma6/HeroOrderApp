...
class ShreeCountersVisitsList extends Component {
  componentDidMount() {
    const {
      dealerId,
      fetchData
...
const mapStateToProps = (state) => ({
  ...
  data    : state.shree.latestVisits,
  loading : state.shree.fetchLatestVisitsLoader
});

const mapDispatchToProps = (dispatch) => ({
  fetchData: (params)    => dispatch(ShreeAction.fetchLatestVisits(params))
});
