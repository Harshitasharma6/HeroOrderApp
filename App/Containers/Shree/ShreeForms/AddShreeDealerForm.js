...
class AddShreeDealerForm extends Component {
 // 	async componentDidMount() {
	...
	// 	this.props.changeForm({ edited_field: 'Latitude', edited_value: location.latitude });
	// 	this.props.changeForm({ edited_field: 'Longitude', edited_value: location.longitude });
    ...
    render() {
		...
		return (
			<View style={Style.container}>
				<Text style={Style.heading}>{'Add Shree Dealer'}</Text>
				<ScrollView 
				...
				>
...

					{
						...
						// 	label={'Counter Type'}
						// 	list={this.state.counterType}
						// 	selected={nonShreeForm.CounterType}
						// 	onChange={(value) => {
						// 		changeNonShreeForm({ edited_field: 'CounterType', edited_value: value })
						// 	}}
						// />

						// <Select style={Style.selectPickerStyle}
						// 	label={'Customer Type'}
						// 	list={this.state.customerType}
