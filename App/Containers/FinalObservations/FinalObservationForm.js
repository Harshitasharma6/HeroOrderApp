...
class FinalObservationForm extends Component {
	render() {
		const { 
			form, 
			changeForm, 
		...
		return (
			<View style={{borderWidth: 1, borderColor: Colors.primary, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-around', marginTop: 20,paddingVertical: 20, paddingHorizontal: 5, borderRadius: 10,backgroundColor: Colors.lightGrey, position: 'relative', width: '100%'}}>

				<BrandComponent list={Brand} value={form.Brand__c} changeForm={(value) => changeForm({ edited_field: 'Brand__c', edited_value: value })} />
